<template>
    <div class="flex-between side-bar mb-3">
        <button type="submit" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button"
            aria-controls="offcanvasExample" class="btn btn-primary gobal-btn  main-btn-hover2 three-line"><i
                class="fa-solid fa-bars"></i></button>
        <div class="bell-message-login">
            <div class="bell-message-icon">
                <router-link to="/inbox" class="items-link">
                    <div class="message-container">
                        <i class="fa-regular fa-message header-common-icon"></i>
                        <span class="count-badge header-common-icon-count-message">0</span>
                    </div>
                </router-link>

                <div class="notification-container">
                    <i class="fa-regular fa-bell header-common-icon-message"></i>
                    <span class="count-badge header-common-icon-count">0</span>
                </div>
            </div>
            <div class="sell-login-gap">
                <button @click="toggleLoginModal" class="main-btn-login main-btn-hover2"
                    style="background-color: white;">Login</button>
                <a href="/" class="main-btn-login-sell main-btn-hover2">+&nbsp;Sell</a>
            </div>
        </div>
    </div>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasExampleLabel">POST/FIND</h5>
            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <div>
                <div class="top-main-header2 mb-3 flex-column justify-content-start">
                    <div class="d-flex header-main-category">
                        <div class="header-icon-bg">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                class="_5120d4ee" alt="OLX Motors">
                                <path
                    ...
                    <div class="d-flex header-main-category">
                        <div class="header-icon-bg">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                class="_5120d4ee" alt="OLX Property">
                                <path
            ...
            <div class="dropdown mt-3">
                <div class="remain-header2 mb-3" style="width: 100%;">
                    <div class="dropdown">
